...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 selection:bg-orange-100">
      ...
      <div className="max-w-[1536px] mx-auto grid grid-cols-12 gap-8 px-6">
        ...
        <aside className="hidden xl:block col-span-2 sticky top-28 self-start">
          <div className="space-y-8">
            ...
            <a href="https://amzn.to/3NtrnUW" target="_blank" rel="noopener nofollow sponsored" className="block rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <Image 
                src="/img/banner-vertical-1.jpg" // Substitua pelo caminho da sua imagem
                alt="Anúncio lateral"
                width={300}
                height={600}
          ...
          <header className="bg-white py-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-black mt-4 mb-6 leading-tight">
                Quais as <span className="text-orange-600"> Melhores Ofertas HOJE</span> para você e sua casa??
              </h1>
